...
| Layer          | Built                                                                                                                                                                                                                                                                                                                                                            | Gap                                                                                                                         |
| -------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| Domain machine | `phase1Brainstorming → … → committed` + Inspector machine. Phase 4 sub-states. Back-navigation (Slice H). REDRAFT_BACKLOG (Slice P). AI-as-actor mutation events + `aiTouchedTicketIds` ephemeral context (Slice Q).                                                                                                                                              | —                                                                                                                            |
...
| Infrastructure | All actors (mock + real LangChain/Gemini, LM Studio fallback), `capacityProvider`, `inspectorMemoryStore`, `inspectorContextProvider`, `draftStore`, `llm.ts`, `realAi/` graphs, `rag/` (epic + ticket embeddings, cosine store), `tools/` (registry + `findSimilarEpics` + `findSimilarTickets`), `ai.ts` adapter. Chat graphs emit `mutations[]` (Slice Q). | —                                                                                                                            |
| Presentation   | All 5 phase panes + `Phase5Inspector`, `DraftPicker`, `BackNavigationModal`, `useInspector`, `DependencyGraphView` (Slice N), chat textareas accept input during AI think (Slice P), AI mutation mode toggle + pulse + ChatGPT-style AI prose (Slice Q).                                                                                                          | —                                                                                                                            |
| E2E            | Playwright bootstrapped; `orchestrator-commit.spec.ts` + `inspector.spec.ts` cover approve happy paths.                                                                                                                                                                                                                                                          | Over-capacity branch; Slice Q AI-mutation specs                                                                              |
